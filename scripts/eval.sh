...
*interleaved*)
    srun --gpus=$N_GPU  \
        ...
        --n_passages 500 --max_seq_len 64 --multi_passages 1  --icl_w_document --run_name $RUN_NAME  --embed_name Llama3.2-3B --llm_name Llama3.1-8B --n_icl_exs 2 --compressed_doc_in_icl

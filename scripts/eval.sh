...
case $SLURM_ARRAY_TASK_ID in
  0)
    ...
    srun --gpus=$N_GPU \
    micromamba run -n llm_embed python embed_llm/generation/evaluation.py --run_name Hybrid_LLM_False_Emb_True_MaxEmb_3_PNoEmbed_0.0_StartPoint_0.5_16BS --eval_reconstruction --out_file /home/hippolytepilchen/code/embed_llm/results/NVEmbed/eval_hybrid_focus.json \
  ...
  1)
    srun --gpus=$N_GPU \
        ...
        --n_passages 500 --max_seq_len 64 --instruct_name Instruct_Hybrid_LLM_False_Emb_True_MaxEmb_1_PNoEmbed_0.0_StartPoint_0.0_16BS
    ;;
  *)

...
CONFIG_FILES=(
config/experiments/multi_decoder_nodistill_CP4_ft_frozen_embed.yaml 
config/experiments/multi_decoder_distill_CP4_ft_frozen_embed.yaml 
config/experiments/multi_decoder_distill_CP4_ft.yaml 
config/experiments/multi_decoder_nodistill_CP4_ft_v2.yaml
)

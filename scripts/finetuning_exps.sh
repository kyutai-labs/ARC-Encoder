...
#SBATCH --job-name=mlp_explore_ft
...
CONFIG_FILES=(
config/experiments/datasets/CP4_L3B_MLP2_M7B_20rec_ft_msmarco.yaml
config/experiments/ablations/ablations_mlp/ft/CP8_L3B_MLP8_M7B_cont_2_ft.yaml

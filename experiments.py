...
def main(args):
    ...
    if args.llm_name == 'Mistral7B':
        with open('/home/hippolytepilchen/code/embed_llm/config/default_mistral.yaml') as file:
            config = yaml.safe_load(file)
    elif args.llm_name == 'Gemma7B':
        with open('/home/hippolytepilchen/code/embed_llm/config/default_gemma.yaml') as file:
            config = yaml.safe_load(file)
...
def arg_parser():
    ...
    parser.add_argument('--llm_name', type=str, default='Mistral7B', choice = ['Gemma7B', 'Llama3.2-3B', 'Mistral7B'])
    ...
    parser.add_argument('--proj_act', type=str, default='id', help='Activation function of the projection MLP', choice= ['id', 'gelu', 'relu'])
